...
<form action="FoodItemControllerServlet" method="GET" onsubmit="return checkInputs()">
<input type="hidden" name="command" value="EDIT" />
<input type="hidden" name="foodItemId" value="${THE_FOOD_ITEM.id }" />

<table>
<tbody>
<tr>
<td><label>Item:</label></td>
<td><input type="text" name="item" value="${THE_FOOD_ITEM.item}"/></td>
</tr>
<tr>
<td><label>Expiry Date:</label></td>
<td><input type="text" name="expiryDate" id="expiryDateInput" value="${THE_FOOD_ITEM.expiryDate}" /></td>
</tr>
<tr>
<td><label>Price:</label></td>
<td><input type="text" name="price" id="priceInput" value="${THE_FOOD_ITEM.price}" /></td>
</tr>
<tr>
<td><label></label></td>
